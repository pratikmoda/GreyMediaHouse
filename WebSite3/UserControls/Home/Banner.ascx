<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Banner.ascx.cs" Inherits="UserControls_Home_Banner" %>
<!-- Bootstrap core CSS -->
...
<div style="min-height: 50px;">
    ...
    <div id="slider1_container" style="display: none; position: relative; margin: 0 auto; top: 0px; left: 0px; width: 1300px; height: 500px; overflow: hidden;">
        ...
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 1300px; height: 500px; overflow: hidden;">
            <div>
                <img u="image" alt="" src2="../images/web-design.jpg" />
            </div>
            <div>
                <img u="image" alt="" src2="../images/seo-banner.jpg" />
            </div>
            <%--<div>
